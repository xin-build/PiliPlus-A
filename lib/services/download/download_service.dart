...
class DownloadService extends GetxService {
  ...
  Future<void> _completeDownload() async {
    ...
    try {
      ...
      final videoM4s = File(path.join(videoDir, PathUtils.videoNameType2));
      final audioM4s = File(path.join(videoDir, PathUtils.audioNameType2));
      final videoMp4 = File(path.join(videoDir, PathUtils.videoNameType1));
      if (videoM4s.existsSync() && audioM4s.existsSync() && !videoMp4.existsSync()) {
