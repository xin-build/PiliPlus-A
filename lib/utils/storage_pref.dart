...
abstract final class Pref {
  ...
  static bool get cdnSpeedTest =>
      _setting.get(SettingBoxKey.cdnSpeedTest, defaultValue: false);
  ...
  static bool get trialVipQuality =>
      _setting.get(SettingBoxKey.trialVipQuality, defaultValue: true);
  ...
  static bool get enableAiTranslate =>
      _setting.get(SettingBoxKey.enableAiTranslate, defaultValue: true);

  static List<int>? get playerBottomBarSort =>
      _setting.get(SettingBoxKey.playerBottomBarSort);
  ...
  static String get videoOutput =>
      _setting.get(SettingBoxKey.videoOutput, defaultValue: '');
  ...
  static int get forwardFastDuration =>
      _setting.get(SettingBoxKey.forwardFastDuration, defaultValue: 10);
