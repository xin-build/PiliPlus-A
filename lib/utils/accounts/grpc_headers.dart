...
abstract final class GrpcHeaders {
  ...
  static Map<String, String> phoneHeaders([String? accessKey]) {
    const phoneBuild = 8090300;
    const phoneVersionName = '8.9.0';
    const phoneMobiApp = 'android';
    return {
      'gzip-accept-encoding': 'gzip,identity',
      'user-agent':
          'bili-universal/$phoneBuild os/android model/22081212C mobi_app/android build/$phoneBuild osVer/14',
      'x-bili-gaia-vtoken': '',
      'x-bili-aurora-zone': '',
      'x-bili-trace-id': _traceId,
      'buvid': _buvid,
