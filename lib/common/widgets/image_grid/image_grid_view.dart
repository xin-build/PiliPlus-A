...
class ImageGridView extends StatelessWidget {
  ...
  void _onTap(BuildContext context, int index) {
    final fullList = images;
    final imgList = fullList ??
        picArr.map(
          (item) {
    ...
    final effectiveIndex = fullList != null
        ? fullList.indexWhere((e) => e.url == picArr[index].url)
        : index;
    final targetIndex = effectiveIndex >= 0 ? effectiveIndex : index;
