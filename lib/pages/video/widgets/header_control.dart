...
class HeaderControlState extends State<HeaderControl>
  ...
  void showSetVideoQa() {
    ...
    final isLogin = videoDetailCtr.isLoginVideo;
              ...
              slivers: [
                  ...
                  child: SizedBox(
                    ...
                    child: GestureDetector(
                      onTap: () => SmartDialog.showToast(
                        '高规格画质可通过试看解锁（需登录账号）；4k和杜比视界播放效果可能不佳',
                      ),
                      child: Row(
                        spacing: 8,
                ...
                SliverList.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isEnabled = availableQa.contains(item.quality) ||
                    ...
                    return ListTile(
                      ...
                      onTap: () async {
                        ...
                        await videoDetailCtr.changeVideoQuality(newQa);
                      },
                      enabled: isEnabled,
                      contentPadding: const EdgeInsets.symmetric(
                        horizontal: 20,
                      ),
                      title: Text(item.newDesc ?? item.format ?? ''),
                      trailing: isCurr
                          ? Icon(
                              Icons.done,
