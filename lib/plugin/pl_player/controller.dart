...
class PlPlayerController with BlockConfigMixin, AudioNormalizationMixin {
  ...
  late final forwardDuration = Duration(
    seconds: Pref.forwardFastDuration,
  );
  late final backwardDuration = Duration(
    seconds: Pref.backwardFastDuration,
  );
  Duration get fastForBackwardDuration => forwardDuration;
  ...
  Future<String> get copyShadersToExternalDirectory async {
    ...
    return shadersDirPath = await AssetUtils.getOrCopy(
      ...
      Assets.mpvAnime4KShaders
          ...
          .followedBy(Assets.mpvCasShader),
  ...
  Future<void> _createVideoController(
    ...
    final isAppStream = dataSource.videoSource.contains('platform=android') ||
        (dataSource.audioSource?.contains('platform=android') ?? false);
